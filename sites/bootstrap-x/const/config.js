{
	...
	icon_md				: '../sites/bootstrap-x/images/bootstrap-logo.jpg',
	script_word			: 'cscript',
	wells				: ['col-md'],
    ...
    var rowControls = [
      '<div class="row-controls">',
        '<a href="javascript:;" class="btn-add-row">+ Row</a>',
        '<a href="javascript:;" class="btn-remove-row">- Row</a>',
      '</div>'
    ].join('');
    var componentControls = [
      '<div class="col-tools">',
        '<a href="javascript:;" class="btn-add-column">+ Column</a>',
        '<a href="javascript:;" class="btn-remove-column">- Column</a>',
        '<a href="javascript:;" class="btn-add-component">+ Component</a>',
      '</div>'
    ].join('');

		$(document).on('click', '.row-controls > .btn-add-row', function () {
			$(this).parents('.row-controls').parents('.row').after([
        '<div class="bsx-bd row">',
          '<div class="col-md">',
            '<div class="controls-wrap">',
              rowControls,
              componentControls,
            '</div>',
            '<div class="c-dummy">Column</div>',
          '</div>',
        '</div>'].join(''));
        Celestia.setSortable('.row');
    });
    
    $(document).on('click', '.btn-remove-row', function () {
      $(this).parents('.row-controls').next().remove().end().remove();
    });
    ...
    // $(document).on('click', '.btn-add-col-row', function () {
    //   $(this).parents('.col-md').append([
    //     '<div class="bsx-bd row">',
    //       '<div class="col-md">',
    //         '<div class="controls-wrap">',
    //           rowControls,
